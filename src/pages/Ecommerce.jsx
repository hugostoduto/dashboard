  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              <p className='font-bold text-gray-400' >Earnigs</p>
              <p className="text-2x1" >R$63,3333,33</p>
            </div>
          </div>
          <div className="mt-6">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gary-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2x1 md:w-780">
          <div className="flex justify-between">
            <p className="font-semibold texr-xl">
              Revenue Updates
            </p>
          ...
          <div className="mt-10 gap-10 flex-wrap justify-center">
            <div className="border-r-1 boder-color m-4 pr-10">
              ...
              <div className="mt-5">
                <SparkLine currentColor="blue" color="blue" id="line-sparkline" type="Line" height="80px" width="250px" data={SparklineAreaData} />
              </div>
              <div className="mt-10">
